...
export default function Confirmation() {
  ...
  return (
    <div className="text-white space-y-4">
      <h2 className="text-golden text-2xl text-center">Confirm your booking</h2>

      <div className="bg-black/50 border border-golden/20 rounded-lg p-4 space-y-3">
        <div>
          <h3 className="text-golden text-sm uppercase tracking-wide">Personal Info</h3>
        ...
        <div className="border-t border-golden/20 pt-3">
          <h3 className="text-golden text-sm uppercase tracking-wide">Date & Time</h3>
          <p>{bookingDate.dateTime || "Not selected"}</p>
          <p className="text-white2 capitalize">{bookingDate.turnTime}</p>
        </div>

        <div className="border-t border-golden/20 pt-3">
          <h3 className="text-golden text-sm uppercase tracking-wide">Details</h3>
          <p>{bookingInfo.numberPersons} guests</p>
