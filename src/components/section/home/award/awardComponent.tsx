...
import SponImage from "../../../common/SponImage";
            ...
            <div className="row-award">
              ...
              <div className="row-trophy">
                <div className="trophy">
                  <div className="image">
                    <Image src={trophy1.src} height={100} width={100} />
                  </div>
                  <div className="text">
                    <h5>Bib Gourmond</h5>
                ...
                <div className="trophy">
                  <div className="image">
                    <Image src={trophy2.src} height={100} width={100} />
                  </div>
                  <div className="text">
                    <h5>Bib Gourmond</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div className="trophy">
                  <div className="image">
                    <Image src={trophy3.src} height={100} width={100} />
                  </div>
                  <div className="text">
                    <h5>Bib Gourmond</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div className="trophy">
                  <div className="image">
                    <Image src={trophy4.src} height={100} width={100} />
                  </div>
                  <div className="text">
                    <h5>Bib Gourmond</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur.</p>
          ...
          <div className="element-50">
            <div className="imageaWard">
              ...
              <div className="gImage">
                <Image src={G.src} height={G.height} width={G.width} />
              </div>
            </div>
          </div>
        </div>
